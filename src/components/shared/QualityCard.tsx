...
const QualityCard = ({ quality }: { quality: Quality }) => {
  return (
    <div
      data-aos="fade-up"
      className=" h-[260px] lg:h-[430px] w-full lg:w-[230px] rounded-lg px-6 space-y-3 lg:space-y-5 flex flex-col justify-center items-center border border-gray-200"
    >
